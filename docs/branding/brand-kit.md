...
[`docs/assets/`](../assets/); this file holds the badge snippets, color tokens,
and the demo slide template reference.

The Slack status-emoji set — one emoji per gate verdict, built on the mark's
"The Cry" signal system — lives in [`emoji/`](emoji/); see
[`emoji/EMOJI.md`](emoji/EMOJI.md) for the legend.
...
![version](https://img.shields.io/badge/version-6.4.0-F0C040?style=flat-square&labelColor=0A0A0A&color=F0C040&logo=data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAzMiAzMiI+PHBvbHlnb24gcG9pbnRzPSI3LDI2IDEzLDE0IDIwLDEzIDIxLDI0IDE2LDI5IDksMzAiIGZpbGw9IiNGMEMwNDAiLz48Y2lyY2xlIGN4PSI3IiBjeT0iMjAiIHI9IjUiIGZpbGw9IiNGMEMwNDAiLz48L3N2Zz4=)
![node](https://img.shields.io/badge/node-20+-F5F5F5?style=flat-square&labelColor=1C1C1C&color=2E2E2E)
...
<!--
<p align="left">
  <img src="https://img.shields.io/badge/canary-v6.4.0-F0C040?style=flat-square&labelColor=0A0A0A" alt="version"/>
  <img src="https://img.shields.io/badge/node-20+-F5F5F5?style=flat-square&labelColor=1C1C1C&color=2E2E2E" alt="node"/>
