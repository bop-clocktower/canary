...
| `scan-config`             | Exits 2 with 26 HIGH findings, every one a false positive: `SEC-AGT-007` matches Markdown inline-code backticks in `CLAUDE.md` prose as if they were hook command strings. Wiring it would block every PR on documentation. Tracked in #719.                                                                                                                                                                    | The upstream `SEC-AGT-007` false positive is fixed            |
