...
- **Oracle Init (Scaffolding):** `oracle init` command for framework
  bootstrapping (TICKET-037).
- **Quality Gates:** Passing security scans, architectural enforcement, and
...
- (Planned) IDE Plugins for VS Code / JetBrains.
- (Planned) Interactive Guided Onboarding.
