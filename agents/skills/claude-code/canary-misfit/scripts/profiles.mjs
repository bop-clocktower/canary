// canary-misfit -- the degradation profile: vocabulary, validation, and
// normalization (#592).
//
// The seeded injection decision that CONSUMES a normalized profile lives in
// `decision.mjs`. It does not import this file: this module defines what a
// profile is and guarantees the shape, that one reads the shape.
//
...
//
// Nothing in this file imports Playwright, and validation is pure: it reads a
// parsed object and returns errors plus a normalized profile, so it is
